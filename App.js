  ...
  return (
    <Tab.Navigator
      screenOptions={{
        ...
        // PENTING: jangan pakai insets.bottom dari useSafeAreaInsets()
        // di sini — di beberapa device/browser, nilainya kebaca salah
        // (bisa ratusan piksel padahal harusnya cuma sekitar 34).
        // Angka tetap di bawah ini jauh lebih bisa diandalkan.
        tabBarStyle: {
        ...
        // React Navigation kadang gak nge-render backgroundColor sampai
        // BENERAN nutup penuh tinggi tab bar (nyisain area transparan
        // di bawah, nunjukin warna putih di baliknya) — jadi kita kasih
        // View background sendiri yang dipaksa flex:1 biar PASTI nutup
        // penuh, gak nyisa celah sama sekali.
        tabBarBackground: () => (
