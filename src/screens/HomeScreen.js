...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.safe}>
      {/* Panel dekorasi absolute — nutupin area status bar dengan warna
          yang sama, TANPA ganggu tinggi total halaman (beda dari
          margin negatif, itu "nyolong" tinggi dari alur normal dan
          malah bikin celah baru muncul di bawah). */}
      <View style={styles.statusBarFiller} />
      <LinearGradient
        colors={[colors.headerGradientStart, colors.headerGradientEnd]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
        style={[styles.header, { paddingTop: 110 }]}
      >
        <View>
...
const styles = StyleSheet.create({
  ...
  statusBarFiller: {
    ...
    backgroundColor: colors.headerGradientStart, zIndex: 0,
  },
